...
<head>
        ...
        <title>Cheese Cake 芝士蛋糕【为了保证口感，请至少提前一天预定】

喜欢浓浓起士，却又不知如何挑选芝士蛋糕的亲，不妨试试这款独家秘制的【重芝士蛋糕】哟～

实打实的原材料，消化饼干做底，进口牛奶、安佳黄油、安佳奶油奶酪等高级配方做面，加上完美的比例融合搅拌成型，美味无敌的芝士蛋糕出炉啦！</title>
          ...
          <!--   <div class="head_nav">
                ...
                <div class="head_wrapper">
                    <div id="common_hd">
                        ...
                        <a class="new_cart_btn for_gaq active" data-for-gaq="加入购物车-top-详情页" href="/cart/index.php?referrerURl=itemid_1872036792"><span></span></a>
            ...
            <div id="item_info_for_show_wrap">
                <section id="item_info" class="rel ">
                    <article id="item_show" class="loading c_txt rel">
                        <div style="background-image: url(&quot;http://wd.geilicdn.com/vshop173391261-1465225028530-ABCCD-s1.jpg?w=480&amp;h=0&quot;); background-repeat: no-repeat; background-size: cover;" data-key="0" class="item-img" id="itemImg" data-share-src="http://wd.geilicdn.com/vshop173391261-1465225028530-ABCCD-s1.jpg?w=480&amp;h=0"></div>
                        <div id="itemSlider" class="swiper-container big animated hide">
                            <ul id="itemSliderBox" class="swiper-wrapper">
                                <li data-key="0" class="swiper-slide"><img src="http://wd.geilicdn.com/vshop173391261-1465225028530-ABCCD-s1.jpg?w=480&amp;h=0" class="swiper-img center"></li>                            </ul>
                    ...
                    <h2 id="item_name">Cheese Cake 芝士蛋糕【为了保证口感，请至少提前一天预定】</h2>
                    
                    <div id="item_price_wrap" class="rel">
                        <p class="item-price-control">
                            <span id="seckill_price" class="hide"></span>
                            <span id="item_price" class="i_pri" data-original-price="16.00-128.00">¥16.00-128.00</span>
                        </p>
             ...
             <!--    <section style="display: block;" id="control_title" class="hide item-block">
                ...
                <section id="item_detail" class="item-block">
                    <div id="detail_wrap">
                        ...
                        <p class="img_des" id="itemDetailName">Cheese Cake 芝士蛋糕【为了保证口感，请至少提前一天预定】<br>
<br>
喜欢浓浓起士，却又不知如何挑选芝士蛋糕的亲，不妨试试这款独家秘制的【重芝士蛋糕】哟～<br>
<br>
实打实的原材料，消化饼干做底，进口牛奶、安佳黄油、安佳奶油奶酪等高级配方做面，加上完美的比例融合搅拌成型，美味无敌的芝士蛋糕出炉啦！</p>
                        <div id="video_wrap" class="hide">&nbsp;</div>
                        
<!--                    <img src="http://wd.geilicdn.com/vshop173391261-1465225028530-ABCCD-s1.jpg?w=1080&amp;h=0" width="100%"></div>-->
...
<!--                                        <a style="margin-top: 40px;" href="//vdian.com?from=iWantItem" target="_blank" id="iWantAShop" class="block c_txt for_gaq rel" data-for-gaq="详情页－我也要开微店">&nbsp;<span style="position: absolute; right: 0px; top: -40px;" id="doReport1"><a class="block" href="/others/report/index.html?userid=173391261&amp;itemID=1872036792">举报</a></span></a>-->
                </section>
            </div>
                ...
                <section id="item_control" class="wrap abs">
                    <div id="item_control_inner" class="wrap margin_auto">
                        <div id="control_item_info" class="rel">
                            <img src="http://wd.geilicdn.com/vshop173391261-1465225028530-ABCCD-s1.jpg?w=110&amp;h=110&amp;cp=1" id="control_item_info_img" class="abs" height="60" width="60">

                            <span id="control_seckill_price" class="hide"></span>
                            <span id="control_item_info_price" class="i_pri">¥16.00-128.00</span>
                        ...
                        <div id="control_wrap">
                                ...
                                <div id="control_sku">
                                    ...
                                    <ul id="sku_ul"><li class="sku_li"><a class="sku_a" data-sku="5392307883" data-stock="10" data-price="16.00">1/8块 6寸芝士蛋糕</a></li><li class="sku_li"><a class="sku_a" data-sku="5392307884" data-stock="5" data-price="128.00">6寸芝士蛋糕（心形）</a></li></ul>
                                </div>
...
<!--                <div class="margin_auto rel hide" id="item_recommend">推荐商品-->
...
<script type="text/javascript" src="${path }/resouce/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript">
    ...
    seajs.use('js/item/index',function(Item){
        var itemInfo = {"status":{"status_code":0,"status_reason":""},"result":{"itemID":"1872036792","addTime":"2016-06-06 22:57:08","update_time":"2016-06-06 22:57:08","stock":"15","price":"16.00-128.00","sold":"0","seller_id":173391261,"is_show_test_center":0,"itemName":"Cheese Cake \u829d\u58eb\u86cb\u7cd5\u3010\u4e3a\u4e86\u4fdd\u8bc1\u53e3\u611f\uff0c\u8bf7\u81f3\u5c11\u63d0\u524d\u4e00\u5929\u9884\u5b9a\u3011<br \/>\n<br \/>\n\u559c\u6b22\u6d53\u6d53\u8d77\u58eb\uff0c\u5374\u53c8\u4e0d\u77e5\u5982\u4f55\u6311\u9009\u829d\u58eb\u86cb\u7cd5\u7684\u4eb2\uff0c\u4e0d\u59a8\u8bd5\u8bd5\u8fd9\u6b3e\u72ec\u5bb6\u79d8\u5236\u7684\u3010\u91cd\u829d\u58eb\u86cb\u7cd5\u3011\u54df\uff5e<br \/>\n<br \/>\n\u5b9e\u6253\u5b9e\u7684\u539f\u6750\u6599\uff0c\u6d88\u5316\u997c\u5e72\u505a\u5e95\uff0c\u8fdb\u53e3\u725b\u5976\u3001\u5b89\u4f73\u9ec4\u6cb9\u3001\u5b89\u4f73\u5976\u6cb9\u5976\u916a\u7b49\u9ad8\u7ea7\u914d\u65b9\u505a\u9762\uff0c\u52a0\u4e0a\u5b8c\u7f8e\u7684\u6bd4\u4f8b\u878d\u5408\u6405\u62cc\u6210\u578b\uff0c\u7f8e\u5473\u65e0\u654c\u7684\u829d\u58eb\u86cb\u7cd5\u51fa\u7089\u5566\uff01","Imgs":["http:\/\/wd.geilicdn.com\/vshop173391261-1465225028530-ABCCD-s1.jpg?w=480&h=0"],"thumbImgs":["http:\/\/wd.geilicdn.com\/vshop173391261-1465225028530-ABCCD-s1.jpg?w=110&h=110&cp=1"],"itemLogo":"http:\/\/wd.geilicdn.com\/vshop173391261-1465225028530-ABCCD-s1.jpg?w=480&h=360&cp=1","titles":[""],"sku":[{"title":"1\/8\u5757 6\u5bf8\u829d\u58eb\u86cb\u7cd5","stock":10,"price":"16.00","id":5392307883,"sold":0},{"title":"6\u5bf8\u829d\u58eb\u86cb\u7cd5\uff08\u5fc3\u5f62\uff09","stock":5,"price":"128.00","id":5392307884,"sold":0}],"free_delivery":0,"remote_free_delivery":0,"extend":{"total_number":0,"total_score":0,"score":0},"buy_stock":0,"remote_area":"\u6d77\u5916\u3001\u6e2f\u3001\u6fb3\u3001\u53f0\u3001\u65b0\u7586\u3001\u897f\u85cf\u3001\u5185\u8499\u3001\u9752\u6d77\u3001\u7518\u8083\u3001\u5b81\u590f\u3001\u6d77\u5357","collectCount":0,"credit_type":0,"credit_num":0,"credit_score":0,"lock_status":2,"lock_timestamp":"","lock_from":"","area_text":"","is_delete":0,"is_down_shelf":0,"is_selling":1,"isClose":"0","is_active":0,"is_active_limit":0,"seckill_or_discount":0,"discount":"","isDelete":0,"next_page":0,"is_fx":0,"is_liutao":0,"discount_price":0,"sf_cod":0,"sf_cod_rate":"","shop_logo":"http:\/\/koudaiwd.b0.upaiyun.com\/default.png","front_cover":"","rate":"0","is_kdpay":1,"is_warrant":1,"is_COD":1,"express_fee":0,"shop_name":"Teaffee \u8336\u4e0e\u5561\u65f6\u5149","shop_url":"http:\/\/weidian.com\/s\/173391261","shop_img":"http:\/\/wd.geilicdn.com\/vshop173391261-1465214394.jpeg?w=640&h=330&cp=1","voice":{"url":"","seconds":0},"is_score":0,"allowAddCart":1,"allowBuy":1,"can_gift":0,"bg_category_id":50012598,"is_show_question_answer":0}};
...
<script src="//wd.api.weidian.com/stat/h5?buyer_id=&amp;track_type=2&amp;item_id=1872036792&amp;user_id=173391261&amp;guid=1465264680706_018430985499726993&amp;wfr=&amp;recommTag=&amp;callback=jsonp_1465268058592_8609830154510134&amp;wfr_public={&quot;referService&quot;:&quot;h5-shop&quot;}"></script></body>
